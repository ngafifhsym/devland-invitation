...
<div class="row justify-content-center ">
    <div class="col-lg-5 justify-content-center shadow p-3 mb-5 bg-body-tertiary rounded position-absolute top-50 start-50 translate-middle">
        <main class="form-registration w-100 m-auto">
            ...
            @csrf
              ...
              <button class="btn btn-primary w-100 py-2 mt-md-5" type="submit">Register</button>
            </form>
            <small class="d-block text-center mt-3">All ready register ? <a href="/login"> Login Now</a></small>
          </main>
    </div>
</div>
